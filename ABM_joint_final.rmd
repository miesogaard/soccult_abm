...
if (t_max == 60) {
  network_cleaned_joint_60 <- network_cleaned
} else if (t_max == 120) {
  network_cleaned_joint_120 <- network_cleaned
}
...
```{r}
write.csv(population, "~/data_joint.csv", row.names = FALSE)
```
